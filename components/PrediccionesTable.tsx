...
// Componente memoizado individual para cada fila
// Solo se re-renderiza si sus props específicas cambian
interface PrediccionRowProps {
...
const PrediccionRow = memo(function PrediccionRow({
  prediccion: pred,
  isSelected,
  onToggleSeleccion,
  onExcludeToggle,
  ...
  // Custom comparison: solo re-renderizar si cambia isSelected o prediccion.id
  return (
    prevProps.isSelected === nextProps.isSelected &&
    prevProps.prediccion.id === nextProps.prediccion.id
  )
})
        ...
        <tbody className="bg-white divide-y divide-gray-200">
          {predicciones.map((pred) => (
            <PrediccionRow
              key={pred.id}
              prediccion={pred}
              isSelected={skusSeleccionados.has(pred.sku)}
